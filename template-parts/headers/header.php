<header class="stonex-header-area header-style-1">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12">
                <div class="stonex-header-wrap">
                    <div class="site-branding ">
                        <?php 
                        stonex_logo_wrap(); 
                        stonex_site_description(); 
                        ?>
                    </div><!-- .site-branding -->
                    <div class="stonex-menu-wrap">
                        <div class="stonex-main-menu-wrap navbar menu-style-inline justify-content-end">
